...
var __request = require('request-promise')
...
__app.get('/', function(req, res){
    ...
    _siteModule = require('./sitemodule/main');

    callFunction = _siteModule(__request);

    callFunction.thichtruyentranh()
    .then(resolve => {
        res.set({'Content-Type': 'text/html; charset=utf-8',
                 'Cache-Control' : 'no-cache',
                 'X-Powered-By'  : 'Nginx-NODEJS'});
        res.status(200).write(resolve);
        res.end;
    })
