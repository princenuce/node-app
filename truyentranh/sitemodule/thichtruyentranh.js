module.exports = function(http_request){
	...
	var func = {
        ...
        searchFilm: function (keyword, callback){
            ...
            let getHtmlFromKeyword = keyword => {
            ...
            let callbackFunction = (err, stt, res){

                let $ = require('cheerio').load(res);

                let href = $('ul.list-movie>li.movie-item>a');

                let _opjectOutput = {'id':[],'name':[],'slug':[]};

                $('ul.list-movie>li.movie-item span.movie-title-1').each((index, item) => {
            ...
            http_request(requestOpject, callbackFunction);
